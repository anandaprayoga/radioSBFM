        ...
        <div class="col-6 mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
              <div class="bungkus d-flex flex-row align-items-center">
                <a href="#" class="nav-link p-0 text-body-secondary">Category</a>
                <i class='bx bxs-chevron-down js-botton arrow '></i>
              </div>
        ...
        <div class="col-md-6  mb-3">
          <form>
            ...
            <div class="d-flex flex-column flex-sm-row w-100 gap-2">
              ...
              <button class="btn text-white" type="button" style="background-color: hsla(220, 32%, 8%, 3)">Subscribe</button>
            </div>
          </form>
        </div>
      </div>
