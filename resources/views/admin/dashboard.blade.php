      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Pendengar Hari Ini</p>
            ...
            <div class="col-4 text-end">
              <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                <i class="fa-solid fa-ear-listen text-lg opacity-10" aria-hidden="true"></i>
          ...
          <div class="row">
            ...
            <div class="col-4 text-end">
              <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                ...
                <i class="fa-solid fa-eye text-lg opacity-10"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-4 text-end">
              <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                ...
                <i class="fa-solid fa-money-bills text-lg opacity-10"></i>
              </div>
            </div>
          </div>
        </div>
