                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="row">
                            <!-- Title -->
                            <div class="col-12">
                                <h5 class="mb-3">Data Informasi</h5>
                            </div>
                            ...
                            <div class="col-12 d-flex flex-column flex-md-row justify-content-between align-items-start mb-3">
                                ...
                                <form action="{{ route('informasis.index') }}" method="GET" class="d-flex mb-3">
                                    <input style="height: 40px;" class="form-control me-2" type="search" name="search" placeholder="Cari Informasi..." aria-label="Search" value="{{ request('search') }}">
