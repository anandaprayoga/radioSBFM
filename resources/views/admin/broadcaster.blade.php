                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @forelse ($broadcasters as $broadcaster)
                                        <tr>
                                            <td class="ps-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $broadcaster->id }}</p>
                                            </td>
            ...
            <div class="modal-body">
                <form id="editBroadcasterForm" action="{{ route('broadcaster.update', 0) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_broadcaster_id" name="broadcaster_id" value="{{ $broadcaster->id }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="edit_nama_broadcaster" class="form-label">Nama Broadcaster</label>
                        <input type="text" class="form-control" id="edit_nama_broadcaster" name="nama_broadcaster" value="{{ $broadcaster->nama_broadcaster }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit_no_hp" class="form-label">No HP</label>
                        <input type="text" class="form-control" id="edit_no_hp" name="no_hp" value="{{ $broadcaster->no_hp }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit_tanggal_bergabung" class="form-label">Tanggal Bergabung</label>
                        <input type="date" class="form-control" id="edit_tanggal_bergabung" name="tanggal_bergabung" value="{{ $broadcaster->tanggal_bergabung }}" required>
                    </div>
